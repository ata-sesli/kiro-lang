...
pub fn canonical_std_module_name(name: &str) -> Option<&'static str> {
    match name {
        ...
        "std_lists" | "lists" => Some("std_lists"),
        "std_maps" | "maps" => Some("std_maps"),
...
impl StdAssets {
    pub fn get(path: &str) -> Option<StdAsset> {
        let data = match path {
            ...
            "lists/header.rs" => include_bytes!("kiro_std/lists/header.rs").as_slice(),
            "lists/std_lists.kiro" => include_bytes!("kiro_std/lists/std_lists.kiro").as_slice(),
            "maps/header.rs" => include_bytes!("kiro_std/maps/header.rs").as_slice(),
            "maps/std_maps.kiro" => include_bytes!("kiro_std/maps/std_maps.kiro").as_slice(),
